...
# zip_code TEXT, inspection_date TEXT, score TEXT, address_city TEXT, address_state TEXT, address TEXT,
# facility_id TEXT, process_description TEXT, address_address TEXT);" 
